      ...
      <div className="flex flex-col gap-2 p-3">
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0">
            ...
            <p className="mt-1">
              <span className="workshop-label bg-[#ffe3c4] text-[#b86a12]">
                🔧 {status}
              </span>
            </p>
          </div>
        ...
        <div className="flex flex-col gap-1 text-[12px] font-semibold text-[#b86a12]">
        ...
        <Button
          className="h-8 bg-stage-production text-[13px] text-white hover:bg-stage-production/90"
          onClick={onOpen}
        >
          Open Project
        </Button>
